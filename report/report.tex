...
\textbf{Comparison protocol:} After training, we generate $4 \times 4$ grids ($16$ images) per seed for both PixelCNN and Tiny LDM, decode through the \emph{same} VQ-VAE, and log wall-clock time on Apple M4 (\texttt{mps}). This isolates prior quality and inference cost while holding the decoder fixed.
