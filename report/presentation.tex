...
\begin{frame}{Do the Samples Match the Scores?}
  ...
  \slidecommenttight{\textbf{Mode collapse:} not obvious on WGAN-GP/SN-GAN boards---varied colors and poses. Next slide zooms into GAN vs.\ VAE; diffusion families sit between on the full grid.}
