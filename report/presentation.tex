...
\begin{frame}{What Happens on Dogs + Cats?}
  ...
  \slidefigurepairfull{chimera_panel.png}{chimera_progress_chimera_64_seed0.png}
  \slidecommenttight{\textbf{Contrast:} cat-only WGAN-GP $\rightarrow$ clean faces (sample slides). Mixed data $\rightarrow$ hybrids, not separate dog and cat modes.}
